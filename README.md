...
[![build status](https://img.shields.io/github/workflow/status/taiki-e/futures-enum/CI/master?style=flat-square&logo=github)](https://github.com/taiki-e/futures-enum/actions)
